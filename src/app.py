...
def fix_tumor_region(tumor_region):
    """
    this patch fix calls to the API that use the old tumor region names "oral_cavity"
    """
    if tumor_region == "oral_cavity":
        return "oral cavity"
    else:
        return tumor_region
...
def base_model():
    ...
    try:
        ...
        query = {"model": model_name,
                    ...
                    "tumor_region": fix_tumor_region(request_data.get('tumor_region')),
